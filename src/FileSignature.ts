...
/**
 * A bunch of corelation data contains file extension, file signature, and mimetype
 */
const FileSignature: { [k: string]: signDetails } = {
    "123": {
    ...
    doc: {
        signs: ["0,0D444F43", "0,CF11E0A1B11AE100", "0,D0CF11E0A1B11AE1", "0,DBA52D00", "512,ECA5C100"],
        mime: "application/msword",
    },
    mxf: {
        signs: ["0,060E2B34020501010D0102010102", "0,3C435472616E7354696D656C696E653E"],
    ...
    iso: {
        signs: ["32769,4344303031", "34817,4344303031", "36865,4344303031"],
        mime: "application/octet-stream",
    },
    ogx: {
    ...
    eps: {
        signs: ["0,252150532D41646F62652D332E3020455053462D332030", "0,C5D0D3C6"],
    ...
    tpl: {
        signs: ["0,0020AF30", "0,6D7346696C7465724C697374"],
    ...
    nsf: {
        signs: ["0,1A0000040000", "0,4E45534D1A01"],
        mime: "application/vnd.lotus-notes",
    },
    ntf: {
        signs: ["0,1A0000", "0,30314F52444E414E43452053555256455920202020202020", "0,4E49544630"],
        mime: "application/vnd.lotus-notes",
    },
    org: {
    ...
    mif: {
        signs: ["0,3C4D616B657246696C6520", "0,56657273696F6E20"],
    ...
    cab: {
        signs: ["0,49536328", "0,4D534346"],
        mime: "application/vnd.ms-cab-compressed",
    },
    xls: {
        signs: ["512,0908100000060500", "0,D0CF11E0A1B11AE1", "512,FDFFFFFF04", "512,FDFFFFFF20000000"],
    ...
    ppt: {
        signs: ["512,006E1EF0", "512,0F00E803", "512,A0461DF0", "0,D0CF11E0A1B11AE1", "512,FDFFFFFF04"],
    ...
    wks: {
        signs: ["0,0E574B53", "0,FF000200040405540200"],
    ...
    prc: {
        signs: ["0,424F4F4B4D4F4249", "60,74424D504B6E5772"],
    ...
    rar: {
        signs: ["0,526172211A0700", "0,526172211A070100"],
    ...
    cap: {
        signs: ["0,52545353", "0,58435000"],
        mime: "application/vnd.tcpdump.pcap",
    },
    dmp: {
        signs: ["0,4D444D5093A7", "0,5041474544553634", "0,5041474544554D50"],
        mime: "application/vnd.tcpdump.pcap",
    },
    wpd: {
        signs: ["0,FF575043"],
    ...
    au: {
        signs: ["0,2E736E64", "0,646E732E"],
        mime: "audio/basic",
    },
    m4a: {
        signs: ["0,00000020667479704D344120", "4,667479704D344120"],
        mime: "audio/mp4",
    },
    mp3: {
        signs: ["0,494433", "0,FFFB"],
        mime: "audio/mpeg",
    },
    oga: {
        signs: ["0,4F67675300020000000000000000"],
    ...
    jpg: {
        signs: ["0,FFD8", "0,FFD8", "0,FFD8", "0,FFD8"],
        mime: "image/jpeg",
    },
    jpeg: {
        signs: ["0,FFD8", "0,FFD8"],
    ...
    tiff: {
        signs: ["0,492049", "0,49492A00", "0,4D4D002A", "0,4D4D002B"],
        mime: "image/tiff",
    },
    tif: {
        signs: ["0,492049", "0,49492A00", "0,4D4D002A", "0,4D4D002B"],
    ...
    hdr: {
        signs: ["0,233F52414449414E43450A", "0,49536328"],
    ...
    wmf: {
        signs: ["0,010009000003", "0,D7CDC69A"],
        mime: "image/wmf",
    },
    eml: {
        signs: ["0,46726F6D3A20", "0,52657475726E2D506174683A20", "0,582D"],
        mime: "message/rfc822",
    },
    art: {
        signs: ["0,4A47040E"],
    ...
    "3gp": {
        signs: ["0,0000001466747970336770", "0,0000002066747970336770"],
        mime: "video/3gpp",
    },
    "3g2": {
        signs: ["0,0000001466747970336770", "0,0000002066747970336770"],
    ...
    m4v: {
        signs: ["0,00000018667479706D703432", "0,00000020667479704D345620", "4,667479706D703432"],
        mime: "video/mp4",
    },
    mpeg: {
        signs: ["0,00000100", "0,FFD8"],
        mime: "video/mpeg",
    },
    mpg: {
        signs: ["0,00000100", "0,000001BA", "0,FFD8"],
        mime: "video/mpeg",
    },
    ogv: {
        signs: ["0,4F67675300020000000000000000"],
    ...
    mov: {
        signs: ["0,00", "0,000000146674797071742020", "4,6674797071742020", "4,6D6F6F76"],
        mime: "video/quicktime",
    },
    cpt: {
        signs: ["0,4350543746494C45", "0,43505446494C45"],
        mime: "application/mac-compactpro",
    },
    sxc: {
        signs: ["0,504B0304", "0,504B0304"],
    ...
    jar: {
        signs: ["0,4A4152435300", "0,504B0304", "0,504B0304140008000800", "0,5F27A889"],
    ...
    swf: {
        signs: ["0,435753", "0,465753", "0,5A5753"],
        mime: "application/x-shockwave-flash",
    },
    sit: {
        signs: ["0,5349542100", "0,5374756666497420286329313939372D"],
    ...
    ra: {
        signs: ["0,2E524D460000001200", "0,2E7261FD00"],
    ...
    flv: {
        signs: ["0,00000020667479704D345620", "0,464C5601"],
        mime: "video/x-flv",
    },
    mkv: {
        signs: ["0,1A45DFA3"],
...
/**
 * Detect File Extension from given MimeType
 * @param mimeType
 * @returns
 */
export function mimeToExtension(mimeType: string) {
    let result = "";
    for (let ext in FileSignature) {
        let { mime } = FileSignature[ext];
...
/**
 * Detect MimeType from given file signature
 * @param signature
 * @returns
 */
export function findMimeType(signature: string) {
    let result = "";
    for (let ext in FileSignature) {
        let { signs, mime } = FileSignature[ext];
        for (let sign of signs) {
            if (sign.includes(signature)) {
                result = mime;
                break;
            }
        }
